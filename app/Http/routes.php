...
Route::get('/message', 'View\MessageController@messageList');
Route::get('/keyword={keyword}', 'View\ArticleController@searchArticle');
...
Route::get('/registerNotice', 'View\MemberController@registerNotice');
...
Route::group(['prefix' => 'service'], function() {
    ...
    Route::post('/addComment', 'Service\CommentController@addComment');
    Route::post('/addMessage', 'Service\MessageController@addMessage');
...
Route::group(['middleware' => 'check.login'], function() {
    Route::group(['prefix' => 'member'], function() {
        Route::get('/index', 'View\MemberController@index');
    });
});
