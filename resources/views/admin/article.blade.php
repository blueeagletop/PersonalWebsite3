            ...
            <tbody>
                ...
                <tr class="text-c">
                    ...
                    <td>
                        ...
                        @else
                        <span class="label label-success radius">{{$ar->top}}</span>
                        @endif
                    </td>
                    <td class="td-status">
                        @if($ar->status == 1)
                    ...
                    <td class="td-manage">
                        <a title="详情" href="javascript:;" onclick="article_detail('文章详情', 'articleDetail={{$ar->id}}', '1', '800', '500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe695;</i> 详情</a><br>
                        <a title="编辑" href="javascript:;" onclick="article_edit('文章编辑', 'editArticle={{$ar->id}}', '1', '800', '500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i> 编辑</a><br>
                        <a title="删除" href="javascript:;" onclick="article_del('{{$ar->title}}', '{{$ar->id}}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i> 删除</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
...
<script type="text/javascript">
    ...
    function article_detail(title, url) {
        var index = layer.open({
            type: 2,
            title: title,
            content: url
