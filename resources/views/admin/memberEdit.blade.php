    ...
    <form action="" method="post"  class="form form-horizontal" id="form-member-edit">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" style="width: 50%" value="{{$member->nickname}}" placeholder="" name="nickname">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>注册账号：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" style="width: 50%" value="{{$member->username}}" placeholder="" name="username">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="email" class="input-text" style="width: 50%" value="{{$member->email}}" placeholder="" name="email">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>qq：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" style="width: 50%" value="{{$member->qq}}" placeholder="" name="qq">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>weixin：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" style="width: 50%" value="{{$member->weixin}}" placeholder="" name="weixin">
            </div>
        </div>
        <div class="row cl">
    ...
    $("#form-member-edit").Validform({
        ...
        callback: function (form) {
            ...
            $('#form-member-edit').ajaxSubmit({
                ...
                url: 'service/editMember', // 需要提交的 url
                dataType: 'json',
                data: {
                    id: "{{$member->id}}",
